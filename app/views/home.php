            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6" style="padding-top: 40px">
                        ...
                        <div class="mt-5">
                            <button id="btn-login" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#logindemo">
                                Entrar
                            </button>

                            <button id="btn-registre" class="btn btn-primary btn-lg" href="registrar.html">Registre agora</button>
                            <button id="btn-saiba" class="btn btn-outline-primary btn-lg">Saiba mais</button>
                        </div>
                    </div>
                        ...
                        <div class="myform bg-dark">
                            ...
                            <form aciton="#">
                                ...
                                <div>
                                    ...
                                    <p>Não tem conta ainda? <a href=registrar.html>Registre-se</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
